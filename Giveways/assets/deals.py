...
def pr_data(get_data_deals) -> pd.DataFrame:
...
def data_transform(pr_data: pd.DataFrame) -> pd.DataFrame:
...
def data_to_sql(data_transform: pd.DataFrame) -> None:
